...
var box1,box2,box3,body1,body2,body3;
...
function setup() {
	...
	World.add(world, packageBody);
	 ...
	 body1 = Bodies.rectangle(width/2,height-45,200,40,{isStatic:true});
	 World.add(world,body1);

	 body2 = Bodies.rectangle(width/2-100,height-85,20,100,{isStatic:true});
